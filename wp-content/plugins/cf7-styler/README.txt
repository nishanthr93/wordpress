...
Tags: style Contact Form 7, cf7 style, Contact Form 7 style, style cf7, how to add style in Contact Form 7, beautiful contact form designs you can steal, cf7, CF7 Customizer, cf7 forms, cf7 skin,  cf7 template, cf7 theme, contactform7, contact form 7, contactform7, contact form 7 addon, contact form 7 css, contact form 7 customizer, Contact Form 7 Designer, Contact Form 7 Skins, Contact Form 7 style plugin, Contact Form 7 styler,  contact form 7 templates, contact form 7 theme, contact form templates, contact form themes 7, customize contact form 7 forms wordpress plugin, form css, form customizer, how to add style in Contact Form 7, how to style contact form 7, Live Preview for Contact Form 7, styler cf7, styler contact form 7, styler for contact form 7, styling contact form, styling contact form 7 wordpress plugin, WordPress Form Customizer, wordpress registration form, wow styler for contact form 7, WOW Style Contact Form 7
Requires PHP: 7.0
...
14 days Pro trial with a few clicks is available in plugin and via sub menu.
...
please watch the tutorial video and 
use the CSS code, both provided inside the tutorials page in the plugin
