	...
	protected function _register_controls() {
		...
		$this->add_control(
			...
			[
				...
				'selectors'  => [
					'{{WRAPPER}} .owl-nav a:before' => 'border-width: {{SIZE}}{{UNIT}}; border-style: solid',
					'{{WRAPPER}} .owl-nav a:after'  => 'border-width:{{SIZE}}{{UNIT}}; border-style: solid',
				],
				'conditions' => [
				   'relation' => 'or',
				   'terms' => [
		...
		$this->add_control(
			...
			[
				...
				'selectors' => [
					'{{WRAPPER}} .owl-nav a:before' => 'border-color: {{VALUE}};',
					'{{WRAPPER}} .owl-nav a:after'  => 'border-color: {{VALUE}};',
				],
			]
		);
		$this->add_control(
			...
			[
				...
				'selectors' => [
					'{{WRAPPER}} .owl-nav a:before' => 'background: {{VALUE}};',
					'{{WRAPPER}} .owl-nav a:after'  => 'background: {{VALUE}};',
				],
			]
		);
		$this->end_controls_tab();
		...
		$this->add_control(
			...
			[
				...
				'selectors' => [
					'
					{{WRAPPER}} .owl-nav a:before,
					{{WRAPPER}} .owl-nav a:after { transition: opacity 0.150s linear; }
					{{WRAPPER}} .owl-nav a:after'  => 'border-color: {{VALUE}};',
				],
			]
		);
		...
		$this->add_control(
			...
			[
				...
				'selectors' => [
					'
					{{WRAPPER}} .owl-nav a:before,
					{{WRAPPER}} .owl-nav a:after, {{WRAPPER}} .owl-nav a:before { transition: opacity 0.150s linear; }
					{{WRAPPER}} .owl-nav a:after'  => 'background: {{VALUE}};',
				],
			]
		);
